"""
FinGuardAI - ML Model Training with KDD Dataset

This script trains the FinGuardAI threat detection model using the KDD Cup dataset,
which contains real-world network traffic with various attack types.
"""
...
def train_threat_detection_model(data_file=None, model_output_path=None):
    """
    Train a threat detection model using KDD dataset
    
    Args:
        data_file: Path to processed KDD data
    ...
    logger.info("Starting threat detection model training with KDD dataset...")
    ...
    # Service can be high cardinality, so use the top most common services
    ...
    if len(features) < 3:
        logger.error("Not enough features found in the dataset")
        return None, 0, []
...
if __name__ == "__main__":
    logger.info("Starting FinGuardAI threat detection model training with KDD dataset...")
